...
const AccountingServicesGrid = () => {
  ...
  return (
    <section className="bg-[#F8F9FA] py-20 px-6 md:px-20 ">
      <h2 className="text-3xl md:text-4xl font-bold text-center text-[#5B2C8E] mb-4">
        {t("accountingServicesGrid.title")}
      </h2>
      <p className="text-[#2E2E2E] text-lg text-center mb-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg">
          <h3 className="font-bold text-lg text-[#5B2C8E] mb-4">
            {t("accountingServicesGrid.cards.0.title")}
          </h3>
          <ul className="text-[#2E2E2E] space-y-2 list-decimal pr-5">
            {items.map((point, idx) => (
              <li key={idx}>{point}</li>
            ))}
          </ul>
