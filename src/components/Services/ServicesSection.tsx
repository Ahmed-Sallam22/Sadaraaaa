  ...
  return (
    <section className="flex flex-col md:flex-row items-center justify-center gap-16 py-16 px-6 md:px-16 max-w-7xl mx-auto">
      ...
      <div className="w-full md:w-1/2 text-right">
        ...
        <p className="text-[#2E2E2E] mb-6 leading-loose">
          {t("ksaServicesIntro")}
        </p>

        <ul className="space-y-4 mb-6">
          <li className="flex items-center gap-2 text-[#57C4B3] font-semibold">
        ...
        <button
          ...
          className="bg-[#5B2C8E] hover:bg-[#4A1E75] text-white font-bold py-3 px-6 rounded-xl transition-all duration-300"
        >
          {t("ksaServicesCTA")}
        </button>
      </div>
